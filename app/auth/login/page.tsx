        ...
        <div className="w-full max-w-md">
          ...
          >
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-neutral-100 mb-2">Bienvenido de vuelta</h1>
              <p className="text-neutral-400">Inicia sesión para continuar tu búsqueda de conexiones</p>
            </div>
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input
                    ...
                    disabled={loading}
                  />
                  <span className="text-sm text-neutral-300">Recordarme</span>
                </label>
                
                <Link href="/auth/forgot-password" className="text-sm text-primary-500 hover:text-primary-300 transition-colors">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  className="flex justify-center items-center px-4 py-2 border border-glass-border rounded-glass text-neutral-300 hover:bg-glass transition-colors disabled:opacity-50"
                  disabled={loading}
                >
            ...
            <p className="mt-8 text-center text-sm text-neutral-400">
              ...
              <Link href="/auth/register" className="text-primary-500 hover:text-primary-300 transition-colors">
                Regístrate aquí
              </Link>
            </p>
          </motion.div>
        ...
        <div className="max-w-md text-center">
          ...
          >
            ...
            <p className="text-xl text-neutral-300 mb-8">
              Miles de personas están esperando para conocerte
            </p>
            <div className="space-y-4">
              {[
                'Conexiones basadas en afinidad emocional',
